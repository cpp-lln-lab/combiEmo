...
Ne27Struct = struct;
Ne27Struct = buildFramesStruct(mainWindow, Ne27Struct, nFrames, frameDuration, allFrameNamesFaces(:, 1), faceFramePath);
Di27Struct = struct;
Di27Struct = buildFramesStruct(mainWindow, Di27Struct, nFrames, frameDuration, allFrameNamesFaces(:, 2), faceFramePath);
Fe27Struct = struct;
Fe27Struct = buildFramesStruct(mainWindow, Fe27Struct, nFrames, frameDuration, allFrameNamesFaces(:, 3), faceFramePath);
Ha27Struct = struct;
Ha27Struct = buildFramesStruct(mainWindow, Ha27Struct, nFrames, frameDuration, allFrameNamesFaces(:, 4), faceFramePath);
Sa27Struct = struct;
Sa27Struct = buildFramesStruct(mainWindow, Sa27Struct, nFrames, frameDuration, allFrameNamesFaces(:, 5), faceFramePath);

Ne30Struct = struct;
Ne30Struct = buildFramesStruct(mainWindow, Ne30Struct, nFrames, frameDuration, allFrameNamesFaces(:, 6), faceFramePath);
Di30Struct = struct;
Di30Struct = buildFramesStruct(mainWindow, Di30Struct, nFrames, frameDuration, allFrameNamesFaces(:, 7), faceFramePath);
Fe30Struct = struct;
Fe30Struct = buildFramesStruct(mainWindow, Fe30Struct, nFrames, frameDuration, allFrameNamesFaces(:, 8), faceFramePath);
Ha30Struct = struct;
Ha30Struct = buildFramesStruct(mainWindow, Ha30Struct, nFrames, frameDuration, allFrameNamesFaces(:, 9), faceFramePath);
Sa30Struct = struct;
Sa30Struct = buildFramesStruct(mainWindow, Sa30Struct, nFrames, frameDuration, allFrameNamesFaces(:, 10), faceFramePath);

Ne32Struct = struct;
Ne32Struct = buildFramesStruct(mainWindow, Ne32Struct, nFrames, frameDuration, allFrameNamesFaces(:, 11), faceFramePath);
Di32Struct = struct;
Di32Struct = buildFramesStruct(mainWindow, Di32Struct, nFrames, frameDuration, allFrameNamesFaces(:, 12), faceFramePath);
Fe32Struct = struct;
Fe32Struct = buildFramesStruct(mainWindow, Fe32Struct, nFrames, frameDuration, allFrameNamesFaces(:, 13), faceFramePath);
Ha32Struct = struct;
Ha32Struct = buildFramesStruct(mainWindow, Ha32Struct, nFrames, frameDuration, allFrameNamesFaces(:, 14), faceFramePath);
Sa32Struct = struct;
Sa32Struct = buildFramesStruct(mainWindow, Sa32Struct, nFrames, frameDuration, allFrameNamesFaces(:, 15), faceFramePath);

Ne33Struct = struct;
Ne33Struct = buildFramesStruct(mainWindow, Ne33Struct, nFrames, frameDuration, allFrameNamesFaces(:, 16), faceFramePath);
Di33Struct = struct;
Di33Struct = buildFramesStruct(mainWindow, Di33Struct, nFrames, frameDuration, allFrameNamesFaces(:, 17), faceFramePath);
Fe33Struct = struct;
Fe33Struct = buildFramesStruct(mainWindow, Fe33Struct, nFrames, frameDuration, allFrameNamesFaces(:, 18), faceFramePath);
Ha33Struct = struct;
Ha33Struct = buildFramesStruct(mainWindow, Ha33Struct, nFrames, frameDuration, allFrameNamesFaces(:, 19), faceFramePath);
Sa33Struct = struct;
...
candlesmallStruct = struct;
candlesmallStruct = buildFramesStruct(mainWindow, candlesmallStruct, nFrames, frameDuration, allFrameNamesObjects(:, 1), objectFramePath);
carrouselStruct = struct;
carrouselStruct = buildFramesStruct(mainWindow, carrouselStruct, nFrames, frameDuration, allFrameNamesObjects(:, 2), objectFramePath);
coffeeStruct = struct;
coffeeStruct = buildFramesStruct(mainWindow, coffeeStruct, nFrames, frameDuration, allFrameNamesObjects(:, 3), objectFramePath);
discsStruct = struct;
discsStruct = buildFramesStruct(mainWindow, discsStruct, nFrames, frameDuration, allFrameNamesObjects(:, 4), objectFramePath);
fanceilingStruct = struct;
fanceilingStruct = buildFramesStruct(mainWindow, fanceilingStruct, nFrames, frameDuration, allFrameNamesObjects(:, 5), objectFramePath);
fireStruct = struct;
fireStruct = buildFramesStruct(mainWindow, fireStruct, nFrames, frameDuration, allFrameNamesObjects(:, 6), objectFramePath);
fireworksStruct = struct;
fireworksStruct = buildFramesStruct(mainWindow, fireworksStruct, nFrames, frameDuration, allFrameNamesObjects(:, 7), objectFramePath);
flagStruct = struct;
flagStruct = buildFramesStruct(mainWindow, flagStruct, nFrames, frameDuration, allFrameNamesObjects(:, 8), objectFramePath);
kettleStruct = struct;
kettleStruct = buildFramesStruct(mainWindow, kettleStruct, nFrames, frameDuration, allFrameNamesObjects(:, 9), objectFramePath);
leavesStruct = struct;
leavesStruct = buildFramesStruct(mainWindow, leavesStruct, nFrames, frameDuration, allFrameNamesObjects(:, 10), objectFramePath);
lpplayerStruct = struct;
lpplayerStruct = buildFramesStruct(mainWindow, lpplayerStruct, nFrames, frameDuration, allFrameNamesObjects(:, 11), objectFramePath);
rouletteStruct = struct;
rouletteStruct = buildFramesStruct(mainWindow, rouletteStruct, nFrames, frameDuration, allFrameNamesObjects(:, 12), objectFramePath);
sewingStruct = struct;
sewingStruct = buildFramesStruct(mainWindow, sewingStruct, nFrames, frameDuration, allFrameNamesObjects(:, 13), objectFramePath);
spinningtopStruct = struct;
spinningtopStruct = buildFramesStruct(mainWindow, spinningtopStruct, nFrames, frameDuration, allFrameNamesObjects(:, 14), objectFramePath);
tireStruct = struct;
tireStruct = buildFramesStruct(mainWindow, tireStruct, nFrames, frameDuration, allFrameNamesObjects(:, 15), objectFramePath);
toiletStruct = struct;
toiletStruct = buildFramesStruct(mainWindow, toiletStruct, nFrames, frameDuration, allFrameNamesObjects(:, 16), objectFramePath);
trafficlightStruct = struct;
trafficlightStruct = buildFramesStruct(mainWindow, trafficlightStruct, nFrames, frameDuration, allFrameNamesObjects(:, 17), objectFramePath);
waterStruct = struct;
waterStruct = buildFramesStruct(mainWindow, waterStruct, nFrames, frameDuration, allFrameNamesObjects(:, 18), objectFramePath);
waterfallsStruct = struct;
waterfallsStruct = buildFramesStruct(mainWindow, waterfallsStruct, nFrames, frameDuration, allFrameNamesObjects(:, 19), objectFramePath);
windmillsStruct = struct;
